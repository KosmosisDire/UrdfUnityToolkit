// Vendored from UnityTechToolkit (Toolkit.MeshGeneration.CylinderMeshGenerator).
// Self-contained (UnityEngine only) so UrdfToolkit has no dependency on TechToolkit.
